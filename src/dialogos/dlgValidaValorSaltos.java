 ...
 * @author JuanCarlos
 */
public class dlgValidaValorSaltos extends java.awt.Dialog {

    /**
     * Creates new form dlgValidaSaltos
     */
    public dlgValidaValorSaltos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Debe ser un valor mayor a 0");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 60, 240, 30));
        ...
        jPanel1.add(pnlOk, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 90, 90, 30));

        jLabel4.setFont(new java.awt.Font("Microsoft JhengHei UI", 0, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Solo se aceptan valores numéricos");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 40, 240, 30));

        add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 350, 130));
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlgValidaValorSaltos dialog = new dlgValidaValorSaltos(new java.awt.Frame(), true);
