 ...
 * @author JuanCarlos
 */
public class dlgWarrning extends java.awt.Dialog {

    /**
     * Creates new form dlgWarrninf
     */
    public dlgWarrning(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, 60, 50));

        txtMessage.setFont(new java.awt.Font("Microsoft JhengHei UI", 0, 14)); // NOI18N
        txtMessage.setForeground(new java.awt.Color(255, 255, 255));
        txtMessage.setText("Dato ingresado no válido");
        jPanel1.add(txtMessage, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 30, 210, 50));
        ...
        jPanel1.add(pnlOk, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 80, 90, 30));
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlgWarrning dialog = new dlgWarrning(new java.awt.Frame(), true);
