 ...
 * @author JuanCarlos
 */
public class dlgValidaSaltos extends java.awt.Dialog {

    /**
     * Creates new form dlgValidaSaltos
     */
    public dlgValidaSaltos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 30, 60, 50));

        jLabel2.setFont(new java.awt.Font("Microsoft JhengHei UI", 0, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Solo se aceptan valores numéricos");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 30, 240, 50));
        ...
        jPanel1.add(pnlOk, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 80, 90, 30));
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlgValidaSaltos dialog = new dlgValidaSaltos(new java.awt.Frame(), true);
